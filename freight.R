...
# 3 Allocate trip origin/destination locations ----
# -----------------------------------------------------------------------------#
...
# find nearest nodes to freight addresses 
...
# 4 Find routes for each freight trip ----
# -----------------------------------------------------------------------------#
...
# 5 Tally freight volumes for each link ----
# -----------------------------------------------------------------------------#
